...
if($userlogin){
	$q="select * from media where permission='public' and userid not in (select userid from block where blockid='$uid') 
		UNION
		select * from media where userid in (select userid from groupmember where groupid in (select groupid from groupmember where userid='$uid'))
			and userid not in (select userid from block where blockid='$uid') 
		order by views desc ";
}
else
	$q="select * from media where permission='public' order by views desc ";
