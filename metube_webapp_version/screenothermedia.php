...
<?php
	...
	$q="select * from media where userid='$targetid' and mediaid NOT IN (select mediaid from channelmedia where channelid='$channelid') order by views desc";
