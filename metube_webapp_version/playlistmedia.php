...
<?php
	...
	$q="select * from media inner join plistmedia on media.mediaid=plistmedia.mediaid where plistmedia.playlistid='$playlistid' order by addtime desc";
	$r=mysql_query($q) or die ("Could not query the database plistmedia: <br />". mysql_error());
...
?>
					...
					<div class = "item">
						...
						Add Time: <?php echo $result_row['addtime'];?></p>
						<p>
						<a href="removemediafromplaylist.php?mid=<?php echo $result_row['mediaid'];?>&playlistid=<?php echo $playlistid;?>" >Remove from list</a></p>
                    </div>
<?php
	}
