...
<?php
	...
	$r=mysql_query($q) or die ("Could not query the database playlist: <br />". mysql_error());
...
?>
					<div class = "item">
                        <p><a target="_blank" href="playlistmedia.php?playlistid=<?php echo $result_row['playlistid'];?>">List Name: <?php echo $result_row['playlistname'];?></a>&nbsp;&nbsp; 
						Create Time: <?php echo $result_row['createtime'];?></p>
						
						<a href="deleteplaylist.php?playlistid=<?php echo $result_row['playlistid'];?>" >Delete Playlist</a></p>
                    </div>
<?php
	}
