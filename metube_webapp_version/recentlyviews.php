...
if($userlogin){
	...
	$q="select * from view inner join media on view.mediaid=media.mediaid where view.userid='$uid' order by view.viewtime desc ";	
	
	
}else{
	$ip = $_SERVER['REMOTE_ADDR'];
	$q="select * from view inner join media on view.mediaid=media.mediaid 
		where media.permission='public' and view.ip='$ip'  order by view.viewtime desc ";
